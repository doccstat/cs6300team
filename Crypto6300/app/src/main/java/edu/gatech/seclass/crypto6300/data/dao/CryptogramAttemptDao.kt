...
interface CryptogramAttemptDao {
    ...
    @Query("SELECT attempts_remaining FROM CryptogramAttempt WHERE user_id = :playerId AND id = :attemptId LIMIT 1")
    fun getAttemptsRemaining(playerId: String, attemptId: String): LiveData<Int>
